  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="space-y-2">
        ...
        <Input id="registration_number" placeholder="e.g., REG/2024/001" value={formData.registration_number} onChange={handleChange('registration_number')} disabled={registerMutation.isPending} className="h-11 text-base" />
